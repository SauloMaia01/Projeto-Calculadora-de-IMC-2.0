...
function validate(){
   ...
   // altura.style.border = 'none'
    ...
    if(!peso.value || !altura.value){
        ...
        console.log('Obsidade | Obesidade: II')
        result.style.color = 'red'
        result.innerHTML = 'Obsidade | Obesidade: II'

        }else{
            console.log('Obsidade Grave | Obesidade: III')
            result.style.color = 'black'
            result.innerHTML = 'Obsidade Grave | Obesidade: III'
        }
        go(2,3)
    }
}